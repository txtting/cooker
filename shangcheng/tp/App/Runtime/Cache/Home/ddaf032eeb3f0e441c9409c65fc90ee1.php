...
<div class="container">
  <h2>你的味道 , 只有你我知道！</h2>
  <form action="<?php echo U('index');?>" method="post" name="cms" onSubmit="return loginok(this)">
    ...
    <div class="form-control verify">
      ...
      <input type="text" name="captcha" id="verify" placeholder="验证码"/>
      <img  src="/index.php/Home/Public/captcha" onclick="this.src='/index.php/Home/Public/captcha/t/'+Math.random()" BORDER="0" ALT="点击刷新验证码" style="cursor:pointer" align="absmiddle" />
    </div>
    <button type="submit">
      登录
    </button>
