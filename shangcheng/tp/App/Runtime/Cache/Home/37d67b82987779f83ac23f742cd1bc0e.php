		...
		<div class="content clearfix">
			...
			<div class="left-content">				
				...
				<div class="meals-listing">
					<ul>
					 <?php if(is_array($rcfood)): $i = 0; $__LIST__ = $rcfood;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rc): $mod = ($i % 2 );++$i;?><li class="meal-details">
							<div class="image"><img src="<?php echo ($rc["picture"]); ?>" width="277px" height="211" alt="<?php echo ($rc["name"]); ?>"></div>
							<div class="info">
								<div class="descr-holder">
									<h3><a href="single.html"><?php echo ($rc["name"]); ?></a></h3>
									<div class="date_categories"><?php echo (date('Y-m-d H:i:s',$rc["addtime"])); ?>| 分类: <a href="<?php echo U('menu');?>">菜单</a>, <a href="#">热菜</a></div>
									<p><?php echo (msubstr(html_entity_decode($rc["about"]),0,200)); ?> </p>
								</div>
								<span class="price">$<?php echo ($rc["price"]); ?></span>
								<a href="/index.php/Home/Index/addCart/id/<?php echo ($rc["id"]); ?>" class="add-to-cart-button"> + 购物车</a>
			...
			<div class="right-content">			
				...
				<div class="cart-box">
					...
					<ul>
						<li class="info">
							<span class="products"><strong><?php echo (session('sumn')); ?></strong> 菜品</span>
