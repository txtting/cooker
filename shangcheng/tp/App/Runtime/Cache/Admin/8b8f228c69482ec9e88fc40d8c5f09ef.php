...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($catedata)): $i = 0; $__LIST__ = $catedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><tr align="center" class="0" id="0_1" id = 'tr_1'>
      <td align="left" class="first-cell" style = 'padding-left="0"'>
              ...
              <span><a href="#" ><?php echo ($va["cat_name"]); ?></a></span>
          </td>
      <td width="10%">0</td>
      ...
      <td width="24%" align="center">
        ...
        <a href="<?php echo U('del',array('id'=>$va['id']));?>" onclick="return confirm('你确定要删除吗？？')" title="移除">移除</a>
      </td>
