	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><img src="<?php echo ($vo["thumb"]); ?>"/><?php if($vo['thumb'] != ''): ?><a href ='javascript:;' class="view" data=<?php echo ($vo["id"]); ?> data-title=<?php echo ($vo["title"]); ?>>【查看大图】</a><?php endif; ?></td>
                ...
                <td class="operate">
                	...
                	<a href ='javascript:;' class="yview" data="<?php echo ($vo["id"]); ?>" data-title="<?php echo ($vo["title"]); ?>">【内容预览】</a> 
                    <a href ='javascript:;' class="down" data="<?php echo ($vo["id"]); ?>">【下载附件】</a> 
                </td>
...
$(function(){
    ...
    $('.view').on('click',function(){
        ...
        layer.open({
            ...
            shade: 0,
            area: ['550px', '90%'],
            content:'/index.php/Admin/Knowledge/bigimage/id/'+kID
         });
    });
    $('.yview').on('click',function(){
        ...
        layer.open({
            ...
            shade: 0,
            area: ['550px', '90%'],
            content:'/index.php/Admin/Knowledge/yulancontent/id/'+kID
         });
    });
