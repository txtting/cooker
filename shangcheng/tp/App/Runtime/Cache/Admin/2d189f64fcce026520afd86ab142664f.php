...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($roledata)): $i = 0; $__LIST__ = $roledata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><tr align="center" class="0" id="0_1" id = 'tr_1'>
      ...
      <td width="20%"><?php echo ($va["role_name"]); ?></td>
       <td width="40%"><?php echo ($va["privnames"]); ?></td>
      <td width="24%" align="center">
        <a href="#">编辑</a> |
        <a href="<?php echo U('delete',array('id'=>$va['id']));?>" title="删除">删除</a>
      </td>
