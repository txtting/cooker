...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($typedata)): $i = 0; $__LIST__ = $typedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><tr align="center" class="0" id="0_1" id = 'tr_1'>
      ...
      <td width="10%"><?php echo ($va["type_name"]); ?></td>
      <td width="24%" align="center">
        <a href="<?php echo U('Attribute/lst',array('type_id'=>$va['id']));?>">属性列表</a> |
        <a href="#">编辑</a> |
